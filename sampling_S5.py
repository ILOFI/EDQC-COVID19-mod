...
def SEIR_MODEL1(Ecumm, Icumm, Rcumm, init_S, init_E, init_I, init_R, bmi, sigma, beta1 = 4.1):
    T = len(Ecumm)
    print(T)
#     case_data = Icumm
...
street_params = {}
street_params[streetname] = {'alpha_trace': mod1['alpha1'].trace(), 'beta_trace': np.array([4.1, ] * mod1['alpha1'].trace().shape[0])}
